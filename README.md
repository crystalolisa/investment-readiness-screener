...
When a company submits financials for investment consideration, the first question isn't whether they're investable - it's whether the submission is complete enough to assess. In a pipeline of African SMEs across multiple currencies, sectors, and documentation standards, that triage step alone determines whether the screen produces decisions you can trust.

As a Digital Engagement Analyst supporting private equity DealRooms for African SMEs, I coordinated the intake, validation, and review of submitted company financials across active investment pipelines. Four criteria drove the first-pass assessment - revenue size, EBITDA margin, revenue growth, and debt load - and every company needed a documented decision: advance, decline, or defer.
